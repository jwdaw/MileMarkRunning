...
export function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-start md:items-center justify-center pt-20 md:pt-28 overflow-hidden">
      {/* Background gradient */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-0 pb-12 sm:py-32">
        <div className="text-center">
          ...
          <h1 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-foreground tracking-tight mb-6 text-balance">
            Run Faster. <span className="text-primary">Train Smarter.</span>
            <br />
            Achieve More.
          </h1>
          ...
          <p className="max-w-2xl mx-auto text-lg sm:text-xl text-muted-foreground mb-10 leading-relaxed text-pretty">
            Join Mile Mark Running Club and transform your running with
            personalized coaching, structured training plans, and a supportive
            community of dedicated professionals and athletes.
          </p>
